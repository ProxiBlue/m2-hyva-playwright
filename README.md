...
|                         |                                 | :heavy_check_mark: it can sort the products by name (z-a)                                                                                            ||           |                                 | :black_square_button: it can change the number of products to be displayed                                                                           |
...
|                         | Checkout tests (guest)          | :black_square_button: it shows the correct products and quantities previously added to the cart                                                      |
|                         |                                 | :black_square_button: it shows correct prices like subtotal, VAT, shipping costs and total                                                           |
|                         |                                 | :black_square_button: it can see coupon discount in checkout                                                                                         |
...
|                         |                                 | :black_square_button: it can find and order in the customer order history after having placed an order                                               |
