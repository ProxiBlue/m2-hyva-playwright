...
test.describe("String/camel case", () => {
  test("should convert string to camelCase", () => {
    ...
    expect(camelCase("the quick 😀 brown fox jumps over the lazy dog")).toBe(
      "theQuick😀BrownFoxJumpsOverTheLazyDog"
    );
    ...
    expect(camelCase("the_quick_brown_fox_jumps_over_the_lazy_dog")).toBe(
      "theQuickBrownFoxJumpsOverTheLazyDog"
    );

    expect(camelCase("thequickbrownfoxjumpsoverthelazydog")).toBe(
      "thequickbrownfoxjumpsoverthelazydog"
    );
