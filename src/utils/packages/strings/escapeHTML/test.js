...
test.describe("String/escapeHTML", () => {
  test("should escape a HTML string", () => {
    expect(escapeHTML('<script src="main.js"></script>')) // eslint-disable-line no-useless-escape
      .toEqual(
        "&lt;script src&#x3D;&quot;main.js&quot;&gt;&lt;&#x2F;script&gt;"
      );

    expect(escapeHTML("Hello & <span>World</span>")).toEqual(
      "Hello &amp; &lt;span&gt;World&lt;&#x2F;span&gt;"
    );

    expect(escapeHTML('<p data-id="1">lorem ipsum</p>')).toEqual(
