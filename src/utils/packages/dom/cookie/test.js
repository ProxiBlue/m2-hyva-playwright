...
test.describe("dom/cookie", () => {
  test("should create, read and delete cookies", () => {
    ...
    expect(document.cookie).toBe(
      "cookie-1=value-1; cookie-2=val%20ue-2; cookie-3=val%3Bue-3; cookie-4=val%2Cue-4; cookie-5=val%09ue-5; cookie-6=val%0Aue-6"
    );

    expect(decodeURIComponent(document.cookie)).toBe(
      "cookie-1=value-1; cookie-2=val ue-2; cookie-3=val;ue-3; cookie-4=val,ue-4; cookie-5=val\tue-5; cookie-6=val\nue-6"
    );
