...
export const order_add_products = '#add_products'
export const add_product_grid = '#sales_order_create_search_grid_table'
export const add_product_to_order_button = '.actions .action-add'
export const order_get_shipping_methods = 'text=Get shipping methods and rates';
export const send_email_confirmation = '#send_confirmation';
