...
export const cart_row_qty_input  = '.input-text.qty';
...
export const update_cart_button   = '.action.update';
export const cart_clear  = '.action.clear';
export const cart_empty  = '.cart-empty';
export const  cart_totals = '#cart-totals';
export const cart_subtotal  = '.cart-summary [data-th="Subtotal"]';
export const cart_shipping  = '[x-text="hyva.formatPrice(segment.value)"]';

export const checkout_button = ".checkout-methods-items .action.primary.checkout"
